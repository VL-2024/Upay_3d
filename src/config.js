export const CONFIG = {
  ...
  playArea: {
    ...
    scatterFenceInsetTop: 0.95,
    scatterFenceInsetBottom: 0.66
  },
  camera: { alpha: Math.PI / 2, beta: 0.44, radius: 16.5, targetY: 0, fov: 0.72 },
  piece: { width: 0.62, height: 1.18, depth: 0.44, spawnHeightMin: 3.0, spawnHeightMax: 4.0, spawnRadiusX: 2.4, spawnRadiusZ: 3.0 },
