export const CONFIG = {
  ...
  playArea: {
    ...
    pieceMargin: 0.34,
    edgePadding: 0.10,
    scatterFenceInsetX: 0.52,
    scatterFenceInsetTop: 0.74,
    scatterFenceInsetBottom: 0.58
  },
  camera: { alpha: Math.PI / 2, beta: 0.44, radius: 16.5, targetY: 0, fov: 0.72 },
  piece: { width: 0.62, height: 1.18, depth: 0.44, spawnHeightMin: 3.2, spawnHeightMax: 4.2, spawnRadiusX: 2.4, spawnRadiusZ: 3.0 },
