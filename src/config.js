export const CONFIG = {
  ...
  piece: { modelLength:.68, modelHeight:.46, modelDepth:.54, width:0.62, height:1.18, depth:0.44, spawnHeightMin:2.8, spawnHeightMax:3.7, spawnRadiusX:2.4, spawnRadiusZ:3.0 },
